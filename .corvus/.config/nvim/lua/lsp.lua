...
-- NOTE: alternative approach: https://alpha2phi.medium.com/neovim-init-lua-e80f4f136030
--
...
local on_attach = function(_, bufnr)
  ...
  map("n", "<S-f>", "<cmd>lua vim.lsp.buf.formatting()<cr>", map_opts)
  map("n", "<C-]>", "<cmd>lua vim.lsp.buf.definition()<cr>", map_opts)
  map("n", "K", "<cmd>lua vim.lsp.buf.hover()<cr>", map_opts)
  map("n", "<C-b>", "<cmd>lua vim.lsp.buf.references()<CR>", map_opts)
  ...
  -- TODO: find a use for vsnip#jumpable other than <Tab>
...
-- local path_to_elixirls = vim.fn.expand("/Users/kurtsymanzik/OtherSoftware/elixir-ls/release/language_server.sh")
local path_to_elixirls = vim.fn.expand("~/.elixir-ls/release/language_server.sh")

-- Helpful tip:
-- https://github.com/neovim/nvim-lspconfig/issues/1021
