Config { font = "xft:JetBrainsMono:pixelsize=16:antialias=true:hinting=true"
       , additionalFonts = []
       , borderColor = "black"
       , border = TopB
       , bgColor = "#282c34"
       ...
       , sepChar = "%"
       , alignSep = "}{"
       , template = "%StdinReader% }{ <fc=#ee9a00>%date%</fc> / %cpu% / %multicoretemp% / %memory% / %eno2% / %disku% / %KSAT% / %uname%"
       }
