...
myBar :: Int -> [Char]
myBar monitor = "xmobar -x " ++ show monitor ++  " ~/.xmonad/xmobar-single.hs"
...
-- TODO: REMOVE AFTER CONFIG IS COMPLETED
defaults = def {
      -- simple stuff
        terminal           = terminalEm,
...
help = unlines ["The default modifier key is 'alt'. Default keybindings:",
    ...
    "mod-Shift-Enter  Launch " ++ terminalEm,
    "mod-p            Launch dmenu",
...
main = do
    ...
    xmproc1 <- spawnPipe $ myBar 1
    setRandomWallpaper ["/usr/share/backgrounds/personal", "/usr/share/backgrounds/pop"]
